...
pub(crate) enum DBOp {
    ...
    Set { col: DBCol, key: Vec<u8>, value: Vec<u8>, anything: Option<Anything> },
    /// Sets `key` to `value`, and additionally debug-checks that the value is
    /// not overwritten.
    Insert { col: DBCol, key: Vec<u8>, value: Vec<u8>, anything: Option<Anything> },
...
impl DBTransaction {
    ...
    pub fn set(&mut self, col: DBCol, key: Vec<u8>, value: Vec<u8>) {
        self.ops.push(DBOp::Set { col, key, value, anything: None });
    }

    pub fn set_anything<T: CloneAny>(
        &mut self,
        col: DBCol,
        key: Vec<u8>,
        value: Vec<u8>,
        ...
        self.ops.push(DBOp::Set { col, key, value, anything: Some(Anything::new(anything)) });
    }

    pub fn insert(&mut self, col: DBCol, key: Vec<u8>, value: Vec<u8>) {
        assert!(col.is_insert_only(), "can't insert: {col:?}");
        self.ops.push(DBOp::Insert { col, key, value, anything: None });
    }

    pub fn insert_anything<T: CloneAny>(
        &mut self,
        col: DBCol,
        key: Vec<u8>,
        value: Vec<u8>,
        ...
        assert!(col.is_insert_only(), "can't insert: {col:?}");
        self.ops.push(DBOp::Insert { col, key, value, anything: Some(Anything::new(anything)) });
    }
...
pub trait Database: Sync + Send {
    ...
    fn get_anything(&self, _col: DBCol, _key: &[u8]) -> io::Result<Option<Anything>> {
        Ok(None)
    }
